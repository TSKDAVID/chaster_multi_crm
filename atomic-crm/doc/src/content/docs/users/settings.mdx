...
description: This document explains how to configure Chaster CRM.
---

Admin users can configure various aspects of Chaster CRM to tailor the application to their specific needs. This includes customizing the user interface, defining categories, etc. 
