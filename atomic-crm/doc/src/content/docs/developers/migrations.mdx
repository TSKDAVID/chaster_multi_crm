---
title: Migrations
description: This document explains how to create and manage database migrations in Chaster CRM.
---

Chaster CRM uses [declarative database schemas](https://supabase.com/docs/guides/local-development/declarative-database-schemas) to manage its database structure. The schema is defined in `.sql` files under `supabase/schemas/`, and migrations are auto-generated from those files.
