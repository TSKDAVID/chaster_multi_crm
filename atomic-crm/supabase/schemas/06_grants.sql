...
grant all on function public.is_chaster_staff() to anon;
grant all on function public.is_chaster_staff() to authenticated;
grant all on function public.is_chaster_staff() to service_role;
...
grant all on function public.has_tenant_role(text[]) to anon;
grant all on function public.has_tenant_role(text[]) to authenticated;
grant all on function public.has_tenant_role(text[]) to service_role;

grant all on function public.is_tenant_super_admin() to anon;
grant all on function public.is_tenant_super_admin() to authenticated;
grant all on function public.is_tenant_super_admin() to service_role;

grant all on function public.transfer_tenant_super_admin(uuid) to anon;
grant all on function public.transfer_tenant_super_admin(uuid) to authenticated;
grant all on function public.transfer_tenant_super_admin(uuid) to service_role;

grant all on function public.set_tenant_id_default() to anon;
grant all on function public.set_tenant_id_default() to authenticated;
grant all on function public.set_tenant_id_default() to service_role;
...
grant all on table public.chaster_team to anon;
grant all on table public.chaster_team to authenticated;
